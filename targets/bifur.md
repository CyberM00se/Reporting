...
<figure><img src="../.gitbook/assets/image (6).png" alt=""><figcaption><p>NsLookup of Domain</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (41).png" alt=""><figcaption><p>nmap of IP to determine services</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (9).png" alt=""><figcaption><p>live webpage</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (18).png" alt=""><figcaption><p>Burpsuite output of view log page.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (10).png" alt=""><figcaption><p>Attack in Burpsuite</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (28).png" alt=""><figcaption><p>Creating Reverse Shell in metasploit</p></figcaption></figure>

This shows how to gain an active reverse shell to the target from Metasploit

<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption><p>elevating the shell to a meterpreter shell</p></figcaption></figure>

We want to elevate the reverse shell to a Meterpreter session so we can execute our privilege Escalation.

<figure><img src="../.gitbook/assets/image (40).png" alt=""><figcaption><p>Settings for the elevated session</p></figcaption></figure>

This shows the options of how to elevate the reverse shell to Meterpreter session

<figure><img src="../.gitbook/assets/image (29).png" alt=""><figcaption><p>How to list sessions</p></figcaption></figure>

Using the command _sessions -i_ we can list the current active sessions

<figure><img src="../.gitbook/assets/image (34).png" alt=""><figcaption><p>elevation setting options</p></figcaption></figure>

This screenshot shows the settings set so you can elevate the connection

<figure><img src="../.gitbook/assets/image (22).png" alt=""><figcaption><p>Active sessions after elevation</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption><p>Searching for vulnerabilities on the webmin service</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (17).png" alt=""><figcaption><p>Webmin version number</p></figcaption></figure>

<figure><img src="../.gitbook/assets/image (25).png" alt=""><figcaption><p>Creating a Proxy in Metasploit</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (11).png" alt=""><figcaption><p>Backdoor Settings</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (12).png" alt=""><figcaption><p>Flags to force the exploit to work</p></figcaption></figure>

<figure><img src="../.gitbook/assets/image (39).png" alt=""><figcaption><p>Screenshot of the exploit running</p></figcaption></figure>

<figure><img src="../.gitbook/assets/image (15).png" alt=""><figcaption><p>Screenshot of Root Flag</p></figcaption></figure>

This screenshot shows the root flag as proof of root compromise.

#### Persistence

<figure><img src="../.gitbook/assets/image (35).png" alt=""><figcaption><p>User Creation </p></figcaption></figure>

This screenshot shows the creation of my own user. This allows me to directly SSH to the target.

<figure><img src="../.gitbook/assets/image (32).png" alt=""><figcaption><p>mod the created user</p></figcaption></figure>

<figure><img src="../.gitbook/assets/image (2).png" alt=""><figcaption><p>my user passwd</p></figcaption></figure>
